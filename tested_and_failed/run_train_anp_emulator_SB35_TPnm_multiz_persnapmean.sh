...
#SBATCH -J anp-sb35-multiz-psm
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_multiz_psm_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_multiz_psm_%j.err
...
echo "=============================================="
echo "ANP Multi-z Training (DDP) — Per-snapshot mean models"
echo "Each redshift gets its own mean model to eliminate cross-z bias"
echo "=============================================="
echo "Date: $(date)"
echo "Node: $(hostname)"
