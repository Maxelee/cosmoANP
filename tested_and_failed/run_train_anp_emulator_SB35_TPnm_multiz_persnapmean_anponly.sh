...
#SBATCH -J anp-sb35-multiz-psm-anponly
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_multiz_psm_anponly_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_multiz_psm_anponly_%j.err
...
echo "=============================================="
echo "ANP Multi-z Training (ANP-only) — Per-snapshot mean models"
echo "Reuses trained per-snapshot mean models from 20260330_171953"
echo "=============================================="
echo "Date: $(date)"
echo "Node: $(hostname)"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${GPUS_PER_NODE}" train_anp_emulator.py \
  ...
  --mean-checkpoint-path anp_training_runs/anp_all_profiles_20260330_171953/mean_model.pt
