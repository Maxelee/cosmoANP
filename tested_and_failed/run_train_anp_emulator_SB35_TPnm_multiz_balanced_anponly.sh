...
#SBATCH -J anp-sb35-mzbal-anp
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_multiz_bal_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_multiz_bal_%j.err
...
MEAN_CKPT="anp_training_runs/anp_all_profiles_20260330_161700/mean_model.pt"

echo "=============================================="
echo "ANP Multi-z Training — ANP-only (reuse mean model)"
