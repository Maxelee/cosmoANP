...
#SBATCH -J anp-sb35-multiz-stratcal
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_multiz_stratcal_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_multiz_stratcal_%j.err

set -euo pipefail

# Keep launch semantics similar to known-good ANP scripts.
unset SLURM_NTASKS
...
# New stratified calibration controls (baseline-equivalent run with this single extension).
...
echo "=============================================="
echo "ANP Multi-z Training (DDP) - Stratified calibration ablation"
echo "Baseline reference: anp_all_profiles_20260325_175639"
echo "Date: $(date)"
echo "Node: $(hostname)"
