...
#SBATCH -J anp-sb35-huber
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_huber_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_huber_%j.err
...
# ─── Huber Mean-Loss + Log-Channel Floor Training ──────────────────────
#
# Based on the anti-overfitting run (20260325_175639, best epoch 200).
#
# Key changes vs that baseline:
#
#  MEAN MODEL (core-bias fix):
#    mean_loss:          mse   →  huber   (conditional median, not mean)
#    mean_epochs:        80    →  120     (Huber converges slower)
#
#  DATA CLEANING:
#    log_channel_floor:  0     →  1e-29   (remove resolution-floor artefacts)
#
#  Everything else identical to the 20260325_175639 run.
#
echo "[INFO] Huber mean-loss + log-channel-floor training."
echo "[INFO] Student-t(df=4), --mean-loss huber, --log-channel-floor 1e-29"
