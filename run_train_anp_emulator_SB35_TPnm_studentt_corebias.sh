...
#SBATCH -J anp-sb35-studt-corebias
#SBATCH -o /mnt/home/mlee1/ceph/logs/anp_studentt_corebias_%j.out
#SBATCH -e /mnt/home/mlee1/ceph/logs/anp_studentt_corebias_%j.err
...
echo "[INFO] Student-t + anti-overfitting + core-bias penalty."
echo "[INFO] Keeps the good 20260325_175639 setup and adds --core-bias-weight 0.05"

/mnt/home/mlee1/venvs/torch3/bin/python -u train_anp_emulator.py \
