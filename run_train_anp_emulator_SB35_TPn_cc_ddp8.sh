#!/bin/bash
#SBATCH --job-name=anp_sb35_cc_ddp8
#SBATCH --output=/mnt/home/mlee1/ceph/logs/anp_sb35_cc_ddp8_%j.out
#SBATCH --error=/mnt/home/mlee1/ceph/logs/anp_sb35_cc_ddp8_%j.err
...
echo "=============================================="
echo "ANP CC Dual-Head Training (DDP) — multi-snap, tuned regularisation"
echo "=============================================="
echo "Date: $(date)"
echo "Node: $(hostname)"
