#!/bin/bash
#SBATCH --job-name=anp_repro_044659
#SBATCH --output=/mnt/home/mlee1/ceph/logs/anp_repro_044659_%j.out
#SBATCH --error=/mnt/home/mlee1/ceph/logs/anp_repro_044659_%j.err
...
# Reproduce training run anp_all_profiles_20260320_044659
...
echo "=============================================="
echo "ANP Reproduction: 044659 (4-channel, 4-snap)"
echo "=============================================="
echo "Date: $(date)"
echo "Node: $(hostname)"
...
USE_MEAN_PRIOR=${USE_MEAN_PRIOR:-1}
TRAIN_STAGE=${TRAIN_STAGE:-full}
MEAN_CKPT_PATH=${MEAN_CKPT_PATH:-}
